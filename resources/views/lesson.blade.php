                ...
                <div class="video d-flex justify-content-evenly col-sm-12">
                    <div class="video_direction ">
                        @if($previousNext['previous'] != null)
                            <a href="/khoa-hoc/{{$course->slug}}/{{$previousNext['previous']->slug}}"
                               class="btn btn-direction btn-primary"><i class="fas fa-arrow-left fa-1x"></i></a>
                        @endif
                    </div>
                    ...
                    <div class="video_direction">
                        @if($previousNext['next'] != null)
                            <a href="/khoa-hoc/{{$course->slug}}/{{$previousNext['next']->slug}}"
                               class="btn btn-direction btn-primary"><i class="fas fa-arrow-right fa-1x"></i></a>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-4 menu-lesson  ">
                ...
                <div class="list-lesson">
                    @foreach($list_lesson as $key=>$index)
                        <div class="child-lesson d-flex {{$index->slug}}"
                             data-text="{{$course->slug}}/{{$index->slug}}">
