...
@section('content')
    ...
    <div class="intro">
        <div
            style="background-image: url('https://images.pexels.com/photos/1181243/pexels-photo-1181243.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260}') "
            class="intro_background parallax-window" data-parallax="scroll" data-speed="0.8"></div>
        <div class="container">
            <div class="row">
                <div class="col">
                ...
                <div class="col-lg-9">
                    <div class="tab_panels">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div
                                                ...
                                                <div class="instructor_image">
                                                    <div><img src="{{asset($index->avatar)}}" alt=""></div>
                                                </div>
                                                <div class="instructor_content">
                                                    <div class="instructor_name"><a
                                                            href="instructors.html">{{$index->name}}</a></div>
                                                        ...
                                                        <ul>
                                                            <li class="d-flex flex-row align-items-center justify-content-start">
                                                                <i class="fa fa-video-camera"
                                                                   aria-hidden="true"></i><span>Video bài giảng <a
                                                                        href="{{asset("api/danh-sach-bai-giang/$index->slug")}}"
                                                                        class="view">Xem</a></span>
                                                            </li>
                        ...
                        <div class="tab_panel reviews">
                            <div class="panel_title"><h6>Review khóa học</h6></div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="review_author_image">
                                                    <div><img src="{{asset($index->avatar)}}" alt="" width="40"
                                                              height="40"></div>
                                                </div>
                                                <div class="review_author">
                                                    <div class="review_author_name"><a href="#">{{$index->username}}</a>
                                                    </div>
                                    ...
                                    <div class="review d-flex justify-content-between">
                                        ...
                                        <div class="comment d-flex flex-column-reverse ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-comment" name="review"
                                                       data-text="1" placeholder="Để lại bình luận của bạn">
                                            </div>
                        ...
                        <div class="tab_panel members">
                            ...
                            <div class="members_list d-flex flex-row flex-wrap align-items-start justify-content-start">
                                ...
                                @foreach($members as $index)
                                    <div class="member">
                                        <div class="member_image"><img src="{{asset($index->avatar)}}" alt="" width="80"
                                                                       height="80"></div>
                    ...
                    <div class="sidebar">
                        ...
                        @else
                            @if(\Illuminate\Support\Facades\Auth::check())
                                <div class="sidebar_top"><a href="" class="warning_buy_course" data-toggle="modal"
                                                            data-target="#confirmBuyCourse">MUA KHÓA HỌC</a></div>
                            @else
                                    ...
                                    <ul class="features_list">
                                        ...
                                        <li class="d-flex flex-row align-items-start justify-content-start">
                                            <div class="feature_title"><i class="fa fa-clock-o"
                                                                          aria-hidden="true"></i><span>Thời gian học</span>
                                            </div>
                                        ...
                                        <!-- Feature -->
                                        <li class="d-flex flex-row align-items-start justify-content-start">
                                            <div class="feature_title"><i class="fa fa-id-badge" aria-hidden="true"></i><span>Truy cập mọi lúc mọi nơi</span>
                                            </div>
                                    ...
                                    @foreach($relationCourse as $index)
                                        <div class="like_item d-flex flex-row align-items-end justify-content-start">
                                            <div class="like_title_container">
                                                <div class="like_title"><a
                                                        href="/khoa-hoc/{{$index->slug}}">{{$index->name}}</a></div>
    ...
    <div class="modal fade" id="confirmBuyCourse" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true" style="margin-top: 230px">
                ...
                $.ajax({
                    ...
                    error: data => {
                        ...
                        if (data['status'] == 403) {
                            ...
                            $(".this-body").append('<div class="alert alert-danger" role="alert"> Bạn vui lòng đăng ký khóa học này !</div>');
                ...
                if (event.keyCode == 13 && $(this).val() != '') {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            let element = `<div class="alert alert-success" role="alert"><p> ${data['message']}</p> </div>`;
                            $('.panel_title').append(element);
                            $('.form-comment').val('');
                            setTimeout(function () {
